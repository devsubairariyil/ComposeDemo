...
fun ComposeContentTestRule.assertProductList(products: List<Product>) {
    products.forEach { product ->
        ...
        val cardContentDescription = "product_card_${product.productCode}"
        onNodeWithTag(cardContentDescription).assertIsDisplayed()
...
//        val scrollableContainer = onNodeWithTag(indicators)
